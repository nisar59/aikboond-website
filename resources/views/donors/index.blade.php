...
<!--                   <div class="col-md-4 form-group">
                    ...
                    <input type="text" name="token" class="form-control filters" placeholder="Token">
                  </div> -->
  ...
  data_table = $('#donors').DataTable({
      ...
      ajax: {
        ...
        error: function (err) {
          if(err.responseJSON.errors){
            Object.keys(err.responseJSON.errors).forEach(function(key) {
              error(err.responseJSON.errors[key]);
            });
          }else{
        ...
        dataSrc: function (data) {
          success('Donors found. contact admin to get donors detail');
          return data.data;
        },
      },
      buttons:[],
